...
return {
	...
	["&new_shencaocao"] = "神曹操",
	["newguixin"] = "归心",
	[":newguixin"] = "每当你受到1点伤害后，你可以依次获得所有其他角色区域内随机的一张牌，然后将武将牌翻面。",
	...
	["dengji"] = "登极",
	[":dengji"] = "觉醒技，准备阶段开始时，若你的“储”不少于3，你减1点体力上限，获得武将牌上的“储”，获得“界奸雄”和“天行”。",
	...
	[":jiufa2"] = "你每使用或打出九张不同牌名的牌后，你可以移除记录，然后亮出牌堆顶的九张牌，你选择并获得其中点数重复的牌各一张，其余的牌置入弃牌堆。",
	["pingxiang"] = "平襄",
	[":pingxiang"] = "限定技，出牌阶段，若你的体力上限大于9，你可以减9点体力上限。若如此做，你视为使用至多九张火【杀】，然后你失去“九伐”且本局游戏你的手牌上限等于体力上限。",
	["pingxiangmax"] = "平襄",
	...
	[":shencai"] = "出牌阶段限一次，你可以令一名其他角色进行判定且你获得判定牌。若判定牌包含以下内容，其获得对应标记（已有标记改为修改）：\
					...
					若判定牌不包含以上内容，该角色获得一枚“死”标记且手牌上限减少其“死”标记数，然后，你获得其区域内一张牌。" ..
	...
	[":shencai1"] = "<font color=\"green\"><b>出牌阶段限%arg1次，</b></font>你可以令一名其他角色进行判定且你获得判定牌。若判定牌包含以下内容，其获得对应标记（已有标记改为修改）：\
					...
					若判定牌不包含以上内容，该角色获得一枚“死”标记且手牌上限减少其“死”标记数，然后，你获得其区域内一张牌。" ..
					"“死”标记数大于存活角色数的角色回合结束时，其死亡。",
	["#ShencaiEffect"] = "%from 的“%arg”标记效果被触发",
	["szfscchi"] = "笞",
	...
	["#XunshiAdd"] = "%from 的“%arg”被触发，“%arg2”发动次数+1",
	["shendengai"] = "神邓艾",
	["#shendengai"] = "带砺山河",
	["tuoyu"] = "拓域",
	...
	["sdatyqingqu"] = "清渠",
	["sdatyjunshan"] = "峻山",
	["@tuoyu1"] = "拓域：你可以选择任意张手牌分配至“丰田”，剩余分配至其他区域",
	["@tuoyu2"] = "拓域：你可以选择任意张手牌分配至“清渠”，剩余分配至其他区域",
	["@tuoyu3"] = "拓域：你可以选择任意张手牌分配至“峻山”，剩余分配至其他区域",
	["xianjin"] = "险进",
	...
	["cuixin"] = "摧心",
	[":cuixin"] = "当你不以此法对上家/下家使用的牌结算后，你可以视为都下家/上家使用同名牌。",
