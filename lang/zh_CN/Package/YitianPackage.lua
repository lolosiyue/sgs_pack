...
return {
	...
	["conghui"] = "聪慧",
        [":conghui"] = "锁定技，你跳过弃牌阶段。",
	["zaoyao"] = "早夭",
        [":zaoyao"] = "锁定技，结束阶段开始时，若你的手牌数大于13，你须弃置所有手牌并失去1点体力。",
	...
	["kegou"] = "克构",
        [":kegou"] = "觉醒技，准备阶段开始时，若你是除主公外唯一的吴势力角色，你减少1点体力上限，获得技能“连营”。",
	...
	["luboyanf"] = "陆伯言(女)",
	["shenjun"] = "神君",
        [":shenjun"] = "锁定技，游戏开始时，你选择自己的性别；准备阶段开始时，你须改变性别；每当你受到异性角色造成的非雷属性伤害时，你防止之。",
	["shaoying"] = "烧营",
	...
	["guzhielai"] = "古之恶来",
	["sizhan"] = "死战",
        [":sizhan"] = "锁定技，每当你受到一次伤害时，你防止此伤害并获得等同于伤害点数的“死战”标记；结束阶段开始时，你弃置所有的“死战”标记并失去等量的体力。",
	["shenli"] = "神力",
