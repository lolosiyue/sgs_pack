...
return {
	...
	["zuixiang"] = "醉乡",
        [":zuixiang"] = "限定技，准备阶段开始时，你可以将牌堆顶的三张牌置于你的武将牌上。此后每个准备阶段开始时，你重复此流程，直到你的武将牌上出现同点数的“醉乡牌”，然后你获得所有“醉乡牌”（不能发动“漫卷”）。你不能使用或打出“醉乡牌”中存在的类别的牌，且这些类别的牌对你无效。",
	["dream"] = "醉乡",
	...
	["shichou"] = "誓仇",
        [":shichou"] = "主公技，限定技，准备阶段开始时，你可以选择一名其他蜀势力角色并交给其两张牌。每当你受到伤害时，你将此伤害转移给该角色，此伤害结算后该角色摸X张牌，直到其第一次进入濒死状态时。（X为伤害点数）",
	...
	["xuehen"] = "雪恨",
        [":xuehen"] = "锁定技，每当你的体力牌横置时，你选择一项：1.弃置当前回合角色X张牌。 2.视为你使用一张无距离限制的【杀】。（X为你已损失的体力值）",
	...
	["tuqi"] = "突骑",
        [":tuqi"] = "锁定技，准备阶段开始时，若你的武将牌上有“扈”，你将所有“扈”置入弃牌堆：若X小于或等于2，你摸一张牌。本回合你与其他角色的距离-X。（X为以此法置入弃牌堆的“扈”的数量）",
	["retinue"] = "扈",
	["@diyyicong"] = "你可以发动“義從”",
