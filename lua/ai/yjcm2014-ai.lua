...
sgs.ai_skill_invoke.yonglve = function(self)
	...
	and self:askForCardChosen(current,"j","dummyReason",sgs.Card_MethodDiscard)
	then
	...
	then
		...
		and (sgs.card_lack[current:objectName()]["Jink"]==1 or getCardsNum("Jink",current,self.player)==0)
